...
#   2. Borra la copia local de NSIS que Tauri descarga solo (%LOCALAPPDATA%\tauri\NSIS): si esa
...
#   3. Si vendor/mysql-8.4.10-winx64.zip esta descargado pero no extraido, lo extrae.
#
# Uso:
...
# 1. Atributo de solo lectura en artefactos de build
$carpetasARevisar = @(
...
# 2. Cache de NSIS: se borra siempre que se corre este script, es chica (~7MB) y se
...
# 3. MySQL portable: extraer si falta
